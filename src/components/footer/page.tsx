...
const Footer = () => {
  return (
    <footer className="bg-[#0f0f3d]/80 backdrop-blur-sm border-t border-gray-800 py-6 w-full fixed bottom-0 left-0 z-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} SynthOS - Verifiable DeFAI Agent Marketplace
            </p>
          </div>
