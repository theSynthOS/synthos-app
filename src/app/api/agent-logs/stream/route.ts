      ...
      try {
        ...
        request.signal.addEventListener('abort', () => {
          ...
          try {
            ...
            console.error('[API Route] Error closing controller on abort:', error);
          }
        });
        ...
        curlProcess.on('exit', (code) => {
          ...
          try {
            ...
            console.error('[API Route] Error closing controller on exit:', error);
          }
        });
      } catch (error) {
        ...
        if (!controllerClosed) {
          try {
            ...
            console.error('[API Route] Error sending stream error message:', enqueueError);
          }
          ...
          try {
            ...
            console.error('[API Route] Error closing controller after error:', closeError);
          }
        }
      }
    }
